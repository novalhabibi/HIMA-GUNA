		...
		<div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(0,0,0,0.3);" data-300="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
			 <div class="container">
				<div class="navbar-header">
					...
					<h1><a class="navbar-brand" href="#" data-0="line-height:90px;" data-300="line-height:50px;">Artikel
					</a></h1>
				</div>
...
$gambar=$row['gambar'];
 ...
 <tr>
 	...
 	<td width="87%" height="27"><a href="detailartikel.php?id_artikel=<?php echo $id_artikel; ?>" title="<?php echo $judul; ?>"><b><?php echo $judul; ?></b></a></td>
 </tr>
 <tr>
 	<?php
 	 //membuat limit isi artikel
$isi_artikel=substr($isi,0, 200);
 // echo $limited_string;
  // ------------------------
?>


 	<td align="justify"><?php echo $isi_artikel; ?> <a href="detailartikel.php?id_artikel=<?php echo $id_artikel; ?>" title="<?php echo $judul; ?>">Read More</a></td>
