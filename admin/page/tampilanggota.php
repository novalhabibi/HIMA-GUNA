...
?>
<body >
<span class="page-title">Data Anggota</span>
...
<table border="1" align="center">
	...
	<tr>
	<td colspan="4" align="center"><a href="?page=editanggota&id=<?php echo $row['id_anggota']; ?>" id="lik">Edit</a>|+++|<a href="?page=tampilanggota&aksi=hapus&id=<?php echo $row['id_anggota']; ?>" id="lik" onClick="return confirm('Anda yakin mau hapus item ini ?');">Hapus</a></td>
	</tr>
	<tr>
	<td colspan="4"><hr></td>
	</tr>
...
<table align="left"><th><a href="?page=tambahanggota">Tambah</a></th></table>
